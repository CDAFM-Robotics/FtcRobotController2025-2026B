...
@Autonomous(name = "Pedro Task Auto Test", group = "Testing")
    ...
    public void init() {
        ...
        taskMaster = new TaskMaster(new SequentialTask(
            new DeadlineTask(
                new SleepTask(27000),
                new SequentialTask(
                    taskMaker.runShootSequenceTask(new Pose(60, 8.5, Math.toRadians(90)), AutoTaskMaker.Side.FAR),
                    ...
                    taskMaker.runShootSequenceTask(new Pose(60, 14, Math.toRadians(180)), AutoTaskMaker.Side.FAR),
            ...
            new FollowPathTask(follower, follower.pathBuilder()
                .addPath(new BezierLine(follower.getPose(), new Pose(36, 36))).setConstantHeadingInterpolation(180)
                .build()
            ),

            new HoldPointTask(follower, new Pose(36, 36, 180))
        ));
    }
