...
@TeleOp(name = "axonTest_Hub3_Port0", group = "Testing")
@Configurable
public class axonTest_Port0_Hub3 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        CRServo launcherServo = hardwareMap.get(CRServo.class, "axonTest");
        AnalogInput launcherAnalogInput = hardwareMap.get(AnalogInput.class, "axonAnalog");
